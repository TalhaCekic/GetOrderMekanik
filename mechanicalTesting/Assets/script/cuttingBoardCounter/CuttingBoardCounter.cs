...
public class CuttingBoardCounter : MonoBehaviour
{
    ...
    //kesme iþlemi.
    public float cuttingDelay = 5;

    [SerializeField] private GameObject knifeAnim;

    void Start()
    {
        knifeAnim = GameObject.Find("bicak");
        knifeAnim.GetComponent<Animator>();

        pickUp.cutting = false;
    }
    ...
    private void knife()
    {
        ...
        {       
            if (counterID == 4.4f)
            {  
                knifeAnim.GetComponent<Animator>().SetBool("cutting",true);
                cuttingDelay -= Time.deltaTime;
                if (cuttingDelay <= 0)
                {  
                    counterID = 4;
                    tomatoSliceDolu = true;
                    tomatodolu = false;
                    SliceNumberTomato.tomatoHowMoney = 3;
                    pickUp.cutting = false;
                    cuttingDelay = 5;
                    knifeAnim.GetComponent<Animator>().SetBool("cutting", false);
                }
            }
            if (counterID == 5.5f)
            {
                ...
                {
                    counterID = 5;
                    lettuceSliceDolu = true;
                    lettucedolu = false;
                    SliceNumberLettuce.LettuceHowMoney = 3;
                    pickUp.cutting = false;
                    cuttingDelay = 5;
                    knifeAnim.GetComponent<Animator>().SetBool("cutting", false);
                }
